...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Sunarya Adnyana";
            $("#favicon").attr("href", "assests/images/sunarya.png");
        }
        else {
...
var typed = new Typed(".typing-text", {
    strings: ["Web Designer.", "Web Developer.", "Android Developer.", "Game Developer."],
    loop: true,
    typeSpeed: 100,
    backSpeed: 25,
    backDelay: 500,
